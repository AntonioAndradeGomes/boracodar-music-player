...
export default function Player(props: Props) {
  const isNotTack = props.id !== "player-3";
  return (
    <div className="player" id={props.id}>
      <div className="info-wrapper">
        <div className="wrapper">
          <img
            src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=764&q=80"
            alt="Capa do Álbum da Rocketseat"
          />
        </div>
        <div className="info">
      ...
      {isNotTack && <div className="tracktime">
        <div className="track"></div>
        <div className="time">
          <div className="total_time">03:20</div>
          <div className="last_time">00:12</div>
        </div>
      </div> }
